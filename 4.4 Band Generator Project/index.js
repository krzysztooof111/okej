...
app.post("/submit", (req, res) => {
  ...
  let radadj= Math.floor(Math.random() *1347)
  let radnoun= Math.floor(Math.random() *4308)
 
  let adject = adj[radadj];
  let non = noun[radnoun]
  res.render("index.ejs",{adject: adject, non: non})
  console.log(non);
});
